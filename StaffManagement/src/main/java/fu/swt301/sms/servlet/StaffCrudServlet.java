...
public class StaffCrudServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        staff.setStaffCode(request.getParameter("staffCode").trim());
staff.setDateOfBirth(java.sql.Date.valueOf(request.getParameter("dateOfBirth")));
staff.setDepartment(request.getParameter("department").trim());
staff.setPosition(request.getParameter("position").trim());
staff.setSalary(new java.math.BigDecimal(request.getParameter("salary")));
staff.setHireDate(java.sql.Date.valueOf(request.getParameter("hireDate")));
    ...
    errorMessage = "Staff code already exists.";
} else if (staffDAO.isEmailExists(staff.getEmail(), staff.getStaffID())) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("delete".equals(action)) {
            ...
            response.sendRedirect("staff-list");
        } else if ("detail".equals(action)) {//của phần fr 9-11
    ...
    request.getRequestDispatcher("staff-detail.jsp")
